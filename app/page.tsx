...
const basePath = '/cnno-1775720751851';
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft artisanal cinnamon rolls that warm the hearts and souls of our community, while providing exceptional customer service and fostering a culture of quality, creativity, and comfort.</p>
                </div>
                <div className="space-y-2">
